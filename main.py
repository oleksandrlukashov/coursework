...
class RandInts:
    ...
    def algorithms_grpah(func):
        def wrapper(*args, **kwargs):
            ...
            bogosort = Algorithms.BogoSort(self.arr)
            ...
            merge_sort = Algorithms.MergeSort(self.arr)
    ...
    def generate_10(self):
        self.arr.append([random.randint(1, 1000) for _ in range(10)])

    @algorithms_grpah
    def generate_50(self):
        self.arr.append([random.randint(1, 1000) for _ in range(50)])

    @algorithms_grpah
    def generate_100(self):
        self.arr.append([random.randint(1, 1000) for _ in range(100)])

    @algorithms_grpah
    def generate_200(self):
        self.arr.append([random.randint(1, 1000) for _ in range(200)])

    @algorithms_grpah
    def generate_500(self):
        self.arr.append([random.randint(1, 1000) for _ in range(500)])

    @algorithms_grpah
    def generate_1000(self):
        self.arr.append([random.randint(1, 1000) for _ in range(1000)])
